...
<template>
  <section class="showcase">
    <div class="floating-contact" aria-hidden="true">
      <a href="tel:0982047123" class="float-icon float-phone" aria-label="Gọi điện">
      ...
      <a href="#" class="float-icon float-zalo" aria-label="Zalo">
        <span>Zalo</span>
      </a>

      <a href="#" class="float-icon float-messenger" aria-label="Messenger">
        <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true">
          <path
